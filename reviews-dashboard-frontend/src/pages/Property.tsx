...
const PropertyPage: React.FC = () => {
      ...
      axios
        ...
        .then((res) => {
          const approvedReviews = res.data.filter(
            (r: Review) =>
              r.listing === decodeURIComponent(listing) &&
              localStorage.getItem(`approved_${r.id}`) === "true"
          );
  ...
  return (
    <div className="bg-[#FCFAF6]    ">
      {/* Header - Réplication : Bleu avec titre et rating */}
          ...
          <div className="  lg:col-span-2 space-y-6 ">
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-gray-600">
                ...
                perfect spot for anyone looking to enjoy the best of East
                London. You’re right by cafes, restaurants, and great transport
                links to the city. The apartment has a lot of space, modern
                amenities, and everything you need for a comfortable stay…
              </p>
            ...
            <div className="  lg:col-span-2 space-y-6 ">
              <div className="bg-white p-6 rounded-lg shadow">
                ...
                <div className="  lg:col-span-2 space-y-6 ">
                    {/* Reviews Section - Dedicated, only approved reviews */}
                    <section className="container mx-auto p-6 bg-white shadow-md rounded-lg">
                      ...
                      {loading ? (
                        ...
                        <div className="grid grid-cols-1 bg-[#F1F3EE] p-6 rounded-lg  md:grid-cols-2 lg:grid-cols-3 gap-6">
                          {reviews.map((r) => (
                ...
                <section className="container mx-auto p-6 bg-white shadow-md rounded-lg mb-6">
                  ...
                  <div className="h-64 bg-gray-300 rounded-lg flex items-center justify-center">
                    <p className="text-gray-600">
                      Map Placeholder (Integrate Google Maps API if needed)
                    </p>
                  </div>
                  <p className="mt-4 text-gray-700">
                    29 Shoreditch Heights, London N1 - Close to Shoreditch High
                    Street station.
                  </p>
                </section>
              </div>
